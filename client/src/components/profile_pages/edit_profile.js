                ...
                <form onSubmit={this.handleSubmit}>
                    <div className="createAth">
                        ...
                        <div className="createJoinTeamButtons">
                            <button className='createAthleteBtnSub'
                                    onClick={this.joinTeam.bind(this)}>Join Team</button>
                            <button className='createAthleteBtnSub'
                                    onClick={this.createTeam.bind(this)}>Create Team</button>
                        </div>
                    </div>
                    <div className="createAthleteBtn">
                        <button className="createAthleteBtnSub">Submit</button>
                        <button className="createAthleteBtnSub" onClick={this.navBack.bind(this)}>Cancel</button>
                    </div>
                </form>
            </div>
        );
